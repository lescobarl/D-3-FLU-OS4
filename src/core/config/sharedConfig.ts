...
export const AUTONOMY_THRESHOLD_DEFAULTS = {
    health: {
        ...
        ttsErrorRateMax: 0.15,
        ttsAvailabilityMin: 0.98,
    ...
    decision: {
        ...
        sampleOpenrouterResponseTimeMs: 12000,
        sampleOpenrouterCo2: 1.0,
        sampleOpenrouterPerceivedLatencyMs: 15000,
        sampleOpenrouterRequestCount: 150,
        sampleGeminiResponseTimeMs: 45000,
        sampleGeminiCo2: 2.5,
        sampleGeminiPerceivedLatencyMs: 50000,
        sampleGeminiRequestCount: 100,
    },
    optimization: {
        minConfidence: 0.65,
        confidenceMax: 0.95,
